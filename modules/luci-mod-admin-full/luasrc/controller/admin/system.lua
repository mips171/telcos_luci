...
function action_sysupgrade()
	...
	elseif step == 2 then
		...
		luci.template.render("admin_system/applyreboot", {
			...
			msg   = luci.i18n.translate("Your Telco Electronics device is installing firmware.<br><b>Do not power off the device until the login screen is available again.</b><hr><h4>Reconnecting</h4><p>To reach the device again it may be necessary to renew the IP address of your computer or reconnect to one of the wireless networks.</p> <p>The device will attempt to bring you back to the login screen after the upgrade completes but you can also refresh this page manually.  If you are remotely upgrading firmware, wait 3 to 5 minutes before trying to reconnect.</p><br><h4>Information</h4><p>The default IP address is: <a href='https://192.168.1.1'>192.168.1.1</a><br>The default wireless network names are: <em><u>Telco X1 Pro 2.4GHz</u></em> and <em><u>Telco X1 Pro 5GHz</u></em></p>"),
